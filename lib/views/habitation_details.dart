  ...
  _buildRentButton() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: LocationStyle.backcgroundColorPurple,
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              format.format(widget._habitation.prixomis),
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              child: Text( 'Louer', style: LocationTextStyle.reservationBlackTextStyle),
              style: ButtonStyle(
                backgroundColor: MaterialStatePropertyAll<Color>(Color(0xFFFFFFFF)),
              ),
            ),
          ),
        ],
